...
class Page {
    ...
    public function show() {
        ...
        if($nowCoolPage == 1){
            ...
            $theFirst   =   "<li><a href='".str_replace('__PAGE__',2,$url)."' >".$this->config['first']."</a></li>";
        }
        ...
        $pageStr     =   str_replace(
            ...
            array($upPage,$theFirst,$prePage,$linkPage,$nextPage,$downPage),$this->config['theme']);
			
			
			// echo $downPage;echo '<br />';echo $pageStr;
